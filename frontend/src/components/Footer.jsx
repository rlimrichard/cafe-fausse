    ...
    <footer className="footer">
      <div className="footer-inner container">
        ...
        <div className="footer-col">
          ...
          <form onSubmit={handleSignup} className="newsletter-form" noValidate>
          ...
          {status === 'success' && <p className="form-success" role="status">Thanks for subscribing!</p>}
          {status === 'already-subscribed' && <p className="form-success" role="status">This email is already subscribed to the newsletter.</p>}
